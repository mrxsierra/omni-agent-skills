...
## Core Rules:
1. Inspect file signatures and dependencies before drafting plans.
2. Break goals down into 15-minute atomic checklist items.
3. NEVER make direct code edits during the planning phase.
