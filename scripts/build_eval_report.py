...
def generate_markdown(records: List[Dict[str, Any]]) -> str:
    ...
    lines.extend([
        ...
        "",
        "# Specific asset with baseline update",
        "python3 scripts/eval_asset.py --asset registry/skills/engineering/clean-code-auditor/SKILL.md --provider agy --save-baseline",
        "```",
        "",
